...
class MainActivity : AppCompatActivity() {
    lateinit var linearLayoutManage: LinearLayoutManager
    lateinit var listDeProtocolosAdapter: ListDeProtocolosAdapter
    lateinit var db : AppDatabase

    var listaDeProtocolos: List<Protocolo> = ArrayList<Protocolo>()
    ...
    private fun initView() {
        ...
        listDeProtocolosAdapter = ListDeProtocolosAdapter(listaDeProtocolos, this, this::deleteAdapter)
